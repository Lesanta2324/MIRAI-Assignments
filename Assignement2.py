...
# Updated Personas with custom instructions, avatars, and names
persona_config = {
    'Best Friend': {
...
# Select character from select box
selected_char = st.selectbox("Choose a character:", list(persona_config.keys()))

# Reset chat history if the user switches characters
...
# Display past chat history using the correct persona styling
...
if question:
    ...
    # 2. Extract configuration details for the selected persona
    ...
    # 3. Format history for the Gemini API call
    api_contents = []
    ...
    # 4. Display persona response with unique avatar and name
